    ...
    <div className="max-w-7xl mx-auto px-4 py-8">
      <div className="mb-10">
        <h1 className="text-4xl font-bold text-white mb-2">
          Welcome to <span className="gradient-text">SeriesForge AI</span>
        </h1>
        <p className="text-gray-400 text-lg">Create AI-powered animated series with multi-agent intelligence</p>
      </div>
      ...
      <div className="mb-8 relative overflow-hidden bg-gradient-to-r from-purple-900/40 via-blue-900/30 to-purple-900/40 border border-purple-500/30 rounded-2xl p-6">
        ...
        <div className="relative flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <div>
            ...
            <h2 className="text-xl font-bold text-white">Generate Konanta Demo</h2>
            <p className="text-gray-300 text-sm mt-1">
              Full pipeline: 5 characters · 8 scenes · narration · storyboard · audio plan · quality control
            </p>
      ...
      <div className="flex items-center justify-between mb-4">
        <h2 className="text-xl font-bold text-white">My Series</h2>
        <Link
          href="/series"
      ...
      {loading ? (
        ...
        <div className="text-center py-16 bg-[#13131a] border border-[#2a2a3e] border-dashed rounded-2xl">
          ...
          <p className="text-gray-500 text-sm mb-6">Create your first series or try the Konanta demo</p>
